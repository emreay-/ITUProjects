...
void loop()
{
	  ...
	  Serial.println();
          ...
          double flow, v1, A1, A2, ro1, ro2, temp1, temp2, alpha, dummy, delta_pressure;
          A1 = M_PI*pow(narrow,2);
          A2 = M_PI*pow(wide,2);
          temp1 = narrow_data._temperature+273.15;
          temp2 = wide_data._temperature+273.15;
          ro1 = narrow_data._pressure*100/(gas_constant*temp1);
          ro2 = wide_data._pressure*100/(gas_constant*temp2);
          delta_pressure = (narrow_data._pressure-wide_data._pressure)*100;
          
          dummy = ro2*pow(A1,2)-ro1*pow(A2,2);
          alpha = sqrt(dummy);
          v1 = A2*sqrt(2*delta_pressure)*1/(alpha);
          flow = A1*v1;
